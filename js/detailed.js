...
/* Artist's */
var monet = document.getElementById("monet").value = 4;
var munch = document.getElementById("munch").value = 5;
var vinci = document.getElementById("vinci").value = 6;
var picasso = document.getElementById("picasso").value = 7;
var botticelli = document.getElementById("botticelli").value = 8;
var vangogh = document.getElementById("vangogh").value = 9;
